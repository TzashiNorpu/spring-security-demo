...
import com.tzashinorpu.springsecuritydemo.controller.RoleController;
...
@Slf4j
public class RoleDTODataListener implements ReadListener<RoleDTO> {
...
*/
	 ...
	 */
	public RoleDTODataListener(RoleController roleController) {
	...
	private void saveData() {
		...
		roleController.batchAdd(cachedDataList);
		log.info("存储数据库成功！");
	}
}