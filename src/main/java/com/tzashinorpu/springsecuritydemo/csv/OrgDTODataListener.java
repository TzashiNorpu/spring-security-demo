...
@Slf4j
public class OrgDTODataListener implements ReadListener<OrgDTO> {
...
*/
	 ...
	 * @param orgController
	 */
	public OrgDTODataListener(OrgController orgController) {
	 ...
	 */
	@Override
	public void invoke(OrgDTO data, AnalysisContext context) {
		try {
	...
	private void saveData() {
		...
		orgController.batchAdd(cachedDataList);
		log.info("存储数据库成功！");
	}
}