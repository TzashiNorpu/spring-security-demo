...
import com.tzashinorpu.springsecuritydemo.controller.UserController;
...
@Slf4j
public class UserDTODataListener implements ReadListener<UserDTO> {
...
*/
	 ...
	 */
	public UserDTODataListener(UserController userController) {
	...
	private void saveData() {
		...
		userController.batchAdd(cachedDataList);
		log.info("存储数据库成功！");
	}
}